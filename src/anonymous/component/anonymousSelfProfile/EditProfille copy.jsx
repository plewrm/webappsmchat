...
import { setGlobalAnonProfileUpdate } from '../../../redux/slices/anonSlices';
                      ...
                      <div className="choose-avatar-body">
                        ...
                        {/* <div className='age-range-container'>
                                                    {Object.keys(ageRangeStates).map((range, index) => (
                                                        ...
                                                        >
                                                            <span className={isDarkMode ? 'age-number' : 'd-age-number'}>{range}</span>
                                                        </div>
                                                    ))}
                                                </div> */}
                        <div className="age-range-container">
                          <div
                            key={0}
                            style={{ backgroundColor: anonProfile.ageRange == 0 ? 'red' : 'blue' }}
                            // className={` ${isDarkMode ? 'age-range' : 'd-age-range'} ${ageRangeStates[range] ? 'active' : ''}`}
                            // onClick={() => handleAgeRangeClick(range, index)}
                          >
                            <span className={isDarkMode ? 'age-number' : 'd-age-number'}>12</span>
                          </div>
                          <div
                            key={1}
                            style={{ backgroundColor: anonProfile.ageRange == 1 ? 'red' : 'blue' }}
                            // className={` ${isDarkMode ? 'age-range' : 'd-age-range'} ${ageRangeStates[range] ? 'active' : ''}`}
                            // onClick={() => handleAgeRangeClick(range, index)}
                          >
                            <span className={isDarkMode ? 'age-number' : 'd-age-number'}>25</span>
                          </div>
                          <div
                            key={2}
                            style={{ backgroundColor: anonProfile.ageRange == 2 ? 'red' : 'blue' }}
                            // className={` ${isDarkMode ? 'age-range' : 'd-age-range'} ${ageRangeStates[range] ? 'active' : ''}`}
                            // onClick={() => handleAgeRangeClick(range, index)}
                          >
                            <span className={isDarkMode ? 'age-number' : 'd-age-number'}>35</span>
                          </div>
                        </div>
                      </div>
                      <div className="setup-next-button-container">
