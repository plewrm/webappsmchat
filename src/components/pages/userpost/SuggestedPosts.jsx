...
const SuggestedPosts = ({
  ...
  const fetchSuggestedPosts = async () => {
    ...
    try {
      const response = await axios.get(`${BASE_URL}${SUGGESTEDPOSTS}`, { headers });
      ...
      //   setTimeline(response.data.posts);
      // }
      // console.log('show suggested posts', response);
    } catch (error) {
      console.error(error);
    } finally {
      setLoading(false);
                ...
                <div className="post-header-container">
                  ...
                  <div className="isrepost-container">
                    <div className="isrepost-logo-container">
                      <img
                        src={
                          isDarkMode ? '/lightIcon/repostLight.svg' : './darkIcon/repostDark.svg'
                        }
                        alt="repost"
              ...
              <>
                ...
                <div className="post-captions-container">
                  ...
                  >
                    {post.type === 2
                      ? HighlightHashtags(post.text)
                      : HighlightHashtags(post.images[captionIndexMap.get(postIndex) || 0].caption)}
                  </p>
                </div>
                {post.type !== 2 && (
                  <div className="post-photo-containers">
                ...
                >
                  ...
                  >
                    {commentReplies[postIndex] ? (
                      <img src="/darkIcon/sendMsgDark.svg" alt="send" className="sendCommentIcon" />
                    ) : (
                      <img
                        src={
                          isDarkMode ? '/lightIcon/unsendLight.svg' : '/darkIcon/msgUnsendDark.svg'
                        }
                        alt="Send"
